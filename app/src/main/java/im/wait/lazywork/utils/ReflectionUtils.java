...
package im.wait.lazywork.utils;
...
public abstract class ReflectionUtils {
     ...
     * twice, unless excluded by a {@link im.wait.lazywork.utils.ReflectionUtils.MethodFilter}.
     *
     * @param clazz class to start looking at
     * @param mc    the callback to invoke for each method
     * @see #doWithMethods(Class, im.wait.lazywork.utils.ReflectionUtils.MethodCallback, im.wait.lazywork.utils.ReflectionUtils.MethodFilter)
     */
     ...
     * <p>The same named method occurring on subclass and superclass will appear
     * twice, unless excluded by the specified {@link im.wait.lazywork.utils.ReflectionUtils.MethodFilter}.
     *
     * @param clazz class to start looking at
     * @param mc    the callback to invoke for each method
